...
ChatItem = (function(_super) {
  ...
  ChatItem.prototype.partial = function() {
...
module.exports = DB = (function(_super) {
  ...
  DB.prototype.set = function(obj) {
    obj.arrv = this.utcTime();
...
module.exports = DOMListener = (function(_super) {
  __extends(DOMListener, _super);

  function DOMListener() {
    return DOMListener.__super__.constructor.apply(this, arguments);
  }
  ...
  DOMListener.prototype.start = function() {
    ...
    i = 0;
    return $(document).on(browserEvents.join(" "), (function(_this) {
      return function(e, peerid) {
        var pageX, pageY, type, _ref, _ref1;
        if (peerid == null) {
          peerid = null;
        }
        pageX = e.pageX, pageY = e.pageY, type = e.type;
        if (typeof pageX === 'undefined') {
          pageY = (_ref = e.target) != null ? _ref.offsetTop : void 0;
          pageX = (_ref1 = e.target) != null ? _ref1.offsetLeft : void 0;
        }
        if (peerid === null && (type === "mousemove" || type === "click" || type === "focus" || type === "focusin")) {
          _this.emit("event", {
            type: "event",
            data: {
              type: type,
...
peer.on("open", function(id) {
  var ChatItem, chatInput, controller, editableInput, view;
  ...
  return KDView.appendToDOMBody(view);
});



},{"./chatitem":1,"./p2p":6}],6:[function(require,module,exports){
var DB, DMP, DOMListener, P2P, peer, sjcl, _;
...
module.exports = P2P = (function() {
  ...
  function P2P(options, callback) {
    ...
    this.domlistener = new DOMListener().start();
    this.domlistener.on("event", function(data) {
  ...
  P2P.prototype.join = function(options, callback) {
    ...
    this.peer.on("connection", function(conn) {
      return log("hello connection i'm " + conn.peer + " and i'm now connected to you.");
    });
  ...
  P2P.prototype.broadcast = function(obj) {
    ...
    obj.peer = this.peerid;
    obj.path = window.location.pathname;
    obj.dept = P2P.db.utcTime();
    _results = [];
    for (peerid in connectedPeers) {
      peer = connectedPeers[peerid];
      if (peerid !== this.peerid) {
        if (peer.send) {
          _results.push(peer.send(JSON.stringify(obj)));
        } else {
          _results.push(log("this " + peerid + " is not for real.", peer));
        }
      }
    }
    return _results;
  ...
  P2P.prototype.connectToPeer = function(requestedPeer) {
    ...
    if (!connectedPeers[requestedPeer]) {
      ...
      c.on("open", function() {
        return console.log("connected to:", requestedPeer);
      });
      c.on("error", function(err) {
        return console.log("err: " + requestedPeer, err);
      });
      c.on("close", function() {
        console.log("" + c.peer + " has left the chat.");
        return delete connectedPeers[c.peer];
      });
      return connectedPeers[requestedPeer] = c;
    }
  };

  P2P.prototype.connectToPeers = function(peers) {
    var info, _ref, _results;
...
},{"./db":2,"./diff_match_patch_uncompressed.js":3,"./domlistener":4,"./peer.js":7,"./sjcl.js":8,"./underscore-min.js":9}],7:[function(require,module,exports){
